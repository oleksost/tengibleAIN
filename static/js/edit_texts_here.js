...
// Marketing Arrays [HEADLINE, TEXT] //
 marketing = {}; 
 //initial marketing
 marketing.event0  = ["Installation of a new asset", "AIN is really great because the installation of new assets is really simple. You just connect your device to the network and all the necessary data is directly pulled from the manufacturer. No more need for updates and no more fear of using outdated software. With AIN you are always on the safe side!"];
...
speaker.service=["Service provider", ""];

// Instruction arrays [Text] //
instruction = {};
instruction.event0 = ["Here you will see the instructions for the asset handling",speaker.manufacture];
